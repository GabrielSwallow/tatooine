...
__device__ void calcAnalysisValues(real *values, uint3 dataIdx, dim3 dataDim)
{
    ...
    values[AN_TORQUE_1_INNER] = 0.0;
    values[AN_TORQUE_1_OUTER] = 0.0;
    values[AN_TORQUE_2_INNER] = 0.0;
    values[AN_TORQUE_2_OUTER] = 0.0;
    values[AN_TORQUE_3_INNER] = 0.0;
    values[AN_TORQUE_3_OUTER] = 0.0;
    int inner_torque_labels[] = {AN_TORQUE_1_INNER, AN_TORQUE_2_INNER, AN_TORQUE_3_INNER};
    int outer_torque_labels[] = {AN_TORQUE_1_OUTER, AN_TORQUE_2_OUTER, AN_TORQUE_3_OUTER};
    ...
    for (int l = 2; l < NB_N; l++)
        {
            ...
            real factor_2 = xgrid * (ygrid - cudaNb.y[l]);
