...
#define NUMBER_OF_ANALYSIS_VALUES 16
#define AN_MASS                   0
#define AN_E                      1
#define AN_PERI                   2
...
#define AN_TORQUE_1_INNER         7
#define AN_TORQUE_1_OUTER         8
#define AN_TORQUE_2_INNER         9
#define AN_TORQUE_2_OUTER         10
#define AN_TORQUE_3_INNER         11
#define AN_TORQUE_3_OUTER         12
#define AN_ACC_1                  13
#define AN_ACC_2                  14
#define AN_ACC_3                  15
 ...
 *********************************************************************** */
{
    ...
    Operators reductionOperators[NUMBER_OF_ANALYSIS_VALUES] = {
        ...
        OP_SUM, 
        OP_MIN,
        OP_SUM, // AN_TORQUE_1_INNER
        OP_SUM, // AN_TORQUE_1_OUTER
        OP_SUM, // AN_TORQUE_2_INNER
        OP_SUM, // AN_TORQUE_2_OUTER
        OP_SUM, // AN_TORQUE_3_INNER
        OP_SUM, // AN_TORQUE_3_OUTER
        OP_SUM, // AN_ACC_1
        OP_SUM, // AN_ACC_2
        OP_SUM, // AN_ACC_3
    };
    ...
    g_dm_planet3 = analysisValues[AN_ACC_3]*g_dt; // this needs to be a mass, or mass rate
    ////////////////////////////////////
    ...
    if (prank == 0)
    {
        ...
        if (g_stepNumber == 0)
        {
            ...
            fprintf(fp, "#  torque_1_inner: inner torque planet 1 [???]\n");
            fprintf(fp, "#  torque_1_outer: outer torque planet 1 [???]\n");
            fprintf(fp, "#  torque_2_inner: total torque planet 2 [???]\n");
            fprintf(fp, "#  torque_2_outer: total torque planet 2 [???]\n");
            fprintf(fp, "#  torque_3_inner: total torque planet 3 [???]\n");
            fprintf(fp, "#  torque_3_outer: total torque planet 3 [???]\n");
            fprintf(fp, "#  acc_1: accretion planet 1 [???]\n");
            fprintf(fp, "#  acc_2: accretion planet 2 [???]\n");
            fprintf(fp, "#  acc_3: accretion planet 3 [???]\n");
            fprintf(fp, "#%-11s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s\n", 
                    "t", "m", "e_d", "peri", "e_d_inner", "peri_inner", "sigma_min", "iter", 
                    "torque_1_inner", "torque_1_outer", "torque_2_inner", "torque_2_outer", "torque_3_inner", "torque_3_outer",  
                    "acc_1", "acc_2", "acc_3");
        }
        else 
        {
        ...
        if (g_time > tpos)
        {
            fprintf(fp, 
                    ...
                    g_stepNumber,
                    analysisValues[AN_TORQUE_1_INNER],
