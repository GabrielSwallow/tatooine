...
#define NUMBER_OF_ANALYSIS_VALUES 9
#define AN_MASS                   0
#define AN_E                      1
#define AN_PERI                   2
 ...
 *********************************************************************** */
{
    ...
    if (prank == 0)
    {
        ...
        if (g_time > tpos)
        {
            fprintf(fp, "%-12.6e  %-12.6e  %-12.6e  %-12.6e  %-12.6e  %-12.6e  %-12.6e  %-12ld  %-12.6e  %-12.6e\n", 
                    g_time, 
