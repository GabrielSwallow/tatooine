 ...
 *********************************************************************** */
{
    ...
    if (prank == 0)
    {
        ...
        if (g_stepNumber == 0)
        {
            ...
            fprintf(fp, "#  torque_1: total torque planet 1 [???]\n");
            fprintf(fp, "#  torque_2: total torque planet 2 [???]\n");
            fprintf(fp, "#  acc_1: accretion planet 1 [???]\n");
            fprintf(fp, "#  acc_2: accretion planet 2 [???]\n");
            fprintf(fp, "#%-11s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s  %-12s\n", 
                    "t", "m", "e_d", "peri", "e_d_inner", "peri_inner", 
                    "sigma_min", "iter", "torque_1", "torque_2", "acc_1", "acc_2");
        }
        else 
        {
            if (tpos < 0.0)
        ...
        if (g_time > tpos)
        {
            fprintf(fp, "%-12.6e  %-12.6e  %-12.6e  %-12.6e  %-12.6e  %-12.6e  %-12.6e  %-12ld  %-12.6e  %-12.6e  %-12.6e  %-12.6e\n", 
                    ...
                    g_stepNumber,
                    analysisValues[AN_TORQUE_1],
                    analysisValues[AN_TORQUE_2],
